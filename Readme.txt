...
8. I’ve attached the keys used to deploy the applications to my azure account, and a new account within azure should use the same configuration, with the exception of the Uri addresses to functions, apps, and the blob storage.
